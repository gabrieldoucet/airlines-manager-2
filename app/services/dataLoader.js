...
angular.module('am2App')
  .factory('dataLoader', ['$http', 'fleetService', 'linesService', 'planesRefService', 'hubsService',
    function ($http, fleetService, linesService, planesRefService, hubsService) {
      return {
        linesPromise: $http({method: 'GET', url: 'http://localhost:3000/data/lines'})
          .then(function (res) {
        ...
        planesRefPromise: $http({method: 'GET', url: 'http://localhost:3000/data/planeSpecs'})
          .then(function (res) {
        ...
        fleetPromise: $http({method: 'GET', url: 'http://localhost:3000/data/planes'})
          .then(function (res) {
        ...
        hubsPromise: $http({method: 'GET', url: 'http://localhost:3000/data/hubs'})
          .then(function (res) {
