...
.controller('fleetController', ['$scope', 'fleetService', 'linesService', 'hubsService', 'calc', 'models',
  function fleetController($scope, fleetService, linesService, hubsService, calc, models) {
